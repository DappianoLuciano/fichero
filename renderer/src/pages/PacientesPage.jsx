...
export default function PacientesPage({ onVerPaciente }) {
  ...
  async function cargar() {
    const data = await window.api.listarPacientes();
    setPacientes(data);
  }
  ...
  async function handleCrear(e) {
    ...
    setGuardando(true);
    try {
      await window.api.crearPaciente({ nombre: n });
      cerrarModal();
  ...
  async function handleEditar(e) {
    ...
    setGuardandoEd(true);
    try {
      await window.api.actualizarPaciente({ id: editId, nombre: n });
      setEditId(null);
  ...
  async function handleEliminar(id) {
    await window.api.eliminarPaciente(id);
    setConfirmId(null);
